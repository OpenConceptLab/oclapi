BASIC_DESCRIPTION_LOCALE = 'Description locale must be one of the valid choices'
BASIC_NAME_LOCALE = 'Name locale must be one of the valid choices'
BASIC_DESCRIPTION_TYPE = 'Description type must be one of the valid choices'
BASIC_NAME_TYPE = 'Name type must be one of the valid choices'
BASIC_DATATYPE = 'Data type must be valid attribute'
BASIC_CONCEPT_CLASS = 'Concept class must be valid attribute'
...
OPENMRS_AT_LEAST_ONE_FULLY_SPECIFIED_NAME = 'A concept must have at least one fully specified name (across all locales)'
