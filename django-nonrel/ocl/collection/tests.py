...
class CollectionReferenceTest(CollectionBaseTest):
    ...
    def test_when_add_concept_with_related_mappings_as_a_reference_and_same_mapping_with_version(self):
        collection = create_collection(self.user1, CUSTOM_VALIDATION_SCHEMA_OPENMRS)
        ...
        collection.expressions = [from_concept.url, mapping.get_latest_version.url]
        collection.full_clean()
        collection.save()
