...
from collection.views import CollectionListView, CollectionRetrieveUpdateDestroyView, CollectionVersionListView, CollectionVersionRetrieveUpdateView
...
urlpatterns = patterns('',
    ...
    #url(r'^(?P<collection>[a-zA-Z0-9\-\.]+)/(?P<version>[a-zA-Z0-9\-\.]+)/concepts/$', CollectionConceptsView.as_view(), name='collection-concept-list')
    #url(r'^(?P<collection>[a-zA-Z0-9\-\.]+)/(?P<version>[a-zA-Z0-9\-\.]+)/concepts/$', CollectionConceptsView.as_view(), name='collection-concept-list')
)
