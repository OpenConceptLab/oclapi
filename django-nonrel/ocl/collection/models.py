...
from .validation_messages import REFERENCE_ALREADY_EXISTS, CONCEPT_FULLY_SPECIFIED_NAME_UNIQUE_PER_COLLECTION_AND_LOCALE, \
...
class Collection(ConceptContainerModel):
    references = ListOverrideField(EmbeddedModelField('CollectionReference'))
...
class CollectionVersion(ConceptContainerVersionModel):
    ...
    collection_snapshot = DictOverrideField(null=True, blank=True)
