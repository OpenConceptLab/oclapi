...
urlpatterns = patterns('',
    ...
    url(r'^(?P<collection>' + NAMESPACE_PATTERN + ')/extras/(?P<extra>' + NAMESPACE_PATTERN + ')/$', CollectionExtraRetrieveUpdateDestroyView.as_view(), name='collection-extra'),
    ...
    url(r'^(?P<collection>' + NAMESPACE_PATTERN + ')/(?P<version>' + NAMESPACE_PATTERN + ')/extras/(?P<extra>' + NAMESPACE_PATTERN + ')/$', CollectionExtraRetrieveUpdateDestroyView.as_view(), name='collectionversion-extra'),
